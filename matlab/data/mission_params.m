...
params.power.panel_area_m2 = 0.01;
params.power.battery_capacity_Wh = 30.0;
params.power.initial_soc = 0.6;
params.power.payload_load_W = 2.5;
params.power.bus_load_W = 4.0;
